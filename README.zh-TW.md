...
**方向條件（4 選 3，需達到 3 個以上）**

| # | 條件 | 做多 🟢 | 做空 🔴 |
|---|------|---------|---------|
| 1 | Keltner 通道突破 | price > 上軌 | price < 下軌 |
| 2 | 成交量方向 | price > VWAP 且 price > VWMA | price < VWAP 且 price < VWMA |
| 3 | EMA 200 趨勢 | price > EMA 200 | price < EMA 200 |
| 4 | RSI 動能 | RSI > 50 | RSI < 50 |

不顯示 emoji 表示條件不足或市場盤整（ADX ≤ 20）。
